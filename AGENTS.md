...
This project is indexed by GitNexus as **ghost-datatype-support-lib** (254 symbols, 347 relationships, 13 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
