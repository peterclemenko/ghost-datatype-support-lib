...
This project is indexed by GitNexus as **ghost-datatype-support-lib** (78 symbols, 94 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
